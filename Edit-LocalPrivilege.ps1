...
.EXAMPLE
    C:\PS> Edit-LocalPrivilege -Identities [User1] -Privileges [Privilege]

    Description:
    Gives the provided privilege to the provided user on the local system.
    
.EXAMPLE 
    C:\PS> Edit-LocalPrivilege -Identities [User1],[User2] -Privileges [Privilege],[Privilege]

    Description:
    Gives both provided privileges to both the provided users on the local system.

.EXAMPLE
    C:\PS> Edit-LocalPrivilege -Identities [User1] -Privileges [Privilege] -ComputerNames [Computer1],[Computer2]
